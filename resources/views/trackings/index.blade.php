                            ...
                            @if ($tracking->person)
                                ...
                                <x-dropdown>
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <form method="POST" action="{{ route('trackings.destroy', $tracking) }}">
                                            @csrf
                                            @method('delete')
                                            <x-dropdown-link :href="route('trackings.destroy', $tracking)" onclick="event.preventDefault(); this.closest('form').submit();">
                                                {{ __('Delete') }}
                                            </x-dropdown-link>
                                        </form>
                                    </x-slot>
